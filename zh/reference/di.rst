...
.. highlights::
    ...
    阅读这部分内容之前, 建议你先阅读这部分内容 :doc:`为什么使用用户服务定位器和依赖注入 <di-explained>`.
...
+-----------------------------+---------------------------------------------+----------------------------------------------------------------------------------------------------+------------------+
| annotations                 | 注解解析器                                  | :doc:`Phalcon\\Annotations\\Adapter\\Memory <../api/Phalcon_Annotations_Adapter_Memory>`           | 是               |
+-----------------------------+---------------------------------------------+----------------------------------------------------------------------------------------------------+------------------+
...
+-----------------------------+---------------------------------------------+----------------------------------------------------------------------------------------------------+------------------+
| modelsCriteria              | model动态条件查询服务                       | :doc:`Phalcon\\Mvc\\Model\\Criteria <../api/Phalcon_Mvc_Model_Criteria>`                           | No               |
+-----------------------------+---------------------------------------------+----------------------------------------------------------------------------------------------------+------------------+
| modelsQuery                 | model查询服务                               | :doc:`Phalcon\\Mvc\\Model\\Query <../api/Phalcon_Mvc_Model_Query>`                                 | No               |
+-----------------------------+---------------------------------------------+----------------------------------------------------------------------------------------------------+------------------+
| modelsQueryBuilderForSelect | model查询构造器服务                         | :doc:`Phalcon\\Mvc\\Model\\Query\\Builder\\Select <../api/Phalcon_Mvc_Model_Query_Builder_Select>` | No               |
+-----------------------------+---------------------------------------------+----------------------------------------------------------------------------------------------------+------------------+
| modelsQueryBuilderForInsert | model插入构造器服务                         | :doc:`Phalcon\\Mvc\\Model\\Query\\Builder\\Insert <../api/Phalcon_Mvc_Model_Query_Builder_Insert>` | No               |
+-----------------------------+---------------------------------------------+----------------------------------------------------------------------------------------------------+------------------+
| modelsQueryBuilderForUpdate | model更新构造器服务                         | :doc:`Phalcon\\Mvc\\Model\\Query\\Builder\\Update <../api/Phalcon_Mvc_Model_Query_Builder_Update>` | No               |
+-----------------------------+---------------------------------------------+----------------------------------------------------------------------------------------------------+------------------+
| modelsQueryBuilderForDelete | model删除构造器服务                         | :doc:`Phalcon\\Mvc\\Model\\Query\\Builder\\Delete <../api/Phalcon_Mvc_Model_Query_Builder_Delete>` | No               |
+-----------------------------+---------------------------------------------+----------------------------------------------------------------------------------------------------+------------------+
| modelsResultsetSimple       | model简单结果集服务                         | :doc:`Phalcon\\Mvc\\Model\\Resultset\\Simple <../api/Phalcon_Mvc_Model_Resultset_Simple>`          | No               |
+-----------------------------+---------------------------------------------+----------------------------------------------------------------------------------------------------+------------------+
| modelsResultsetComplex      | model复杂结果集服务                         | :doc:`Phalcon\\Mvc\\Model\\Resultset\\Complex <../api/Phalcon_Mvc_Model_Resultset_Complex>`        | No               |
+-----------------------------+---------------------------------------------+----------------------------------------------------------------------------------------------------+------------------+
...
=============================================
如果你想对已有的服务类进行扩展，只需要继承对应服务类或者实现对应接口，然后注入替换即可，示范：
