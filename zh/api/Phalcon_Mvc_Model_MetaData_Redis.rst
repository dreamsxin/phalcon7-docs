...
:raw-html:`<a href="https://github.com/dreamsxin/cphalcon7/blob/master/ext/mvc/model/metadata/redis.c" class="btn btn-default btn-sm">Source on GitHub</a>`

Stores model meta-data in the Redis cache. Data will erased if the web server is restarted  By default meta-data is stored for 48 hours (172800 seconds)  You can query the meta-data by printing redis_get('$PMM$') or redis_get('$PMM$my-app-id')  
...
public *string*  **getCacheKey** (:doc:`Phalcon\\Mvc\\Model <Phalcon_Mvc_Model>` $model, *string* $table, *string* $schema) inherited from Phalcon\\Mvc\\Model\\MetaData
