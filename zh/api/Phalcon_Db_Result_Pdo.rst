...
:raw-html:`<a href="https://github.com/dreamsxin/cphalcon7/blob/master/phalcon/db/result/pdo.zep" class="btn btn-default btn-sm">Source on GitHub</a>`
...
public *mixed*  **fetch** ([*unknown* $fetchMode], [*unknown* $fetchArgument], [*unknown* $ctorArgs])
