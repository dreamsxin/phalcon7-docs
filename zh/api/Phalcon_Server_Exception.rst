Class **Phalcon\\Server\\Exception**
====================================
...
:raw-html:`<a href="https://github.com/dreamsxin/cphalcon7/blob/master/ext/server/exception.c" class="btn btn-default btn-sm">Source on GitHub</a>`
