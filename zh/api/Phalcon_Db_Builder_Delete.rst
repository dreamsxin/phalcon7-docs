Class **Phalcon\\Db\\Builder\\Delete**
======================================
...
:raw-html:`<a href="https://github.com/dreamsxin/cphalcon7/blob/master/ext/db/builder/delete.c" class="btn btn-default btn-sm">Source on GitHub</a>`
...
public  **__construct** ([*unknown* $table], [*unknown* $db])
