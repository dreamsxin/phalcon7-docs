...
project = 'Phalcon7'
copyright = '2018, Phalcon Team and contributors'
...
latex_documents = [
  ('index', 'PhalconDocumentation.tex', 'Phalcon PHP Framework Documentation', 'Phalcon Team', 'manual'),
]
...
man_pages = [
    ('index', 'phalcondocumentation', 'Phalcon Framework Documentation', ['Phalcon Team'], 1)
]
